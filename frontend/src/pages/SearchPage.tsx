...
export default function SearchPage() {
  ...
  }, [currentPage, sortBy, localSearchQuery]);
  ...
  // ===== ÜRÜNLERI ÇEK (TÜM KATEGORİLERDEN) =====
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // TÜM ÜRÜNLERDE ARAMA
        if (localSearchQuery) {
          params.append('keyword', localSearchQuery);
        }

        // TÜM ÜRÜNLERI GETIR
        const url = `${apiUrl}/v1/products/search?${params.toString()}`;
    ...
    fetchProducts();
  }, [currentPage, sortBy, localSearchQuery, priceRange, selectedBrands]);
  ...
  }, [localSearchQuery, priceRange, products, selectedBrands]);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-900">
              {localSearchQuery ? `"${localSearchQuery}" Arama Sonuçları` : 'Tüm Ürünler'}
            </h1>
          </div>
